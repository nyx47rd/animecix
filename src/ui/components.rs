...
/// Favorilere ekleme / çıkarma ikonu olan yuvarlak buton
...
/// Maratona ekleme / çıkarma ikonu olan yuvarlak buton
...
/// Sayfa boş kaldığında gösterilen AdwStatusPage yer tutucusu
